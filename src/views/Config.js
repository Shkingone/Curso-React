    ...
    return (
        <div style={{ width: "100vw", height: "100vh", }}>
            <div style={{
                ...
                <div style={{minHeight:"10px", display: "flex", gap:"10px", width: "100%", borderRadius:"10px", backgroundColor: "white", marginTop: "10px" }}>
                    <Button color="error" fullWidth>Eliminar</Button>
                    <Button color="success" fullWidth>Guardar</Button>
                </div>
